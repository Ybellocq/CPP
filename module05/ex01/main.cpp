...
int main()
{
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Bobby", 149);
        std::cout << bureaucrat << std::endl;
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Boubou", 1);
        std::cout << bureaucrat << std::endl;
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Bubu", 126);
        std::cout << bureaucrat << std::endl;
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Bibi", 125);
        std::cout << bureaucrat << std::endl;
        Form form("Dossier3", 50, 51);
        std::cout << form << std::endl << std::endl;
        form.beSigned(bureaucrat);
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Baba", 100);
        std::cout << bureaucrat << std::endl;
    ...
    try
    {
        ...
        Bureaucrat bureaucrat("Baubau", 100);
        std::cout << bureaucrat << std::endl;
